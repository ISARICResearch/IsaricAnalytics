...
.. figure:: ../../_static/plot_gallery/fig_table.png
   :width: 100%
   :alt:   Table plot
   :target: ../../_static/plot_gallery/fig_table.html
...
Here are the Python steps you need to generate the plot above using the :py:func:`~isaricanalytics.visualisation.fig_table` function:
